...
?>
            ...
            <p>The list of admins (ie. those who can change the allocated list) is hard coded in auth.php. You still have to do it the SRCF way if you want to be able to edit the code</p>
<?
}
?>
        </div>
